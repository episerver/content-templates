...
namespace Stride.Mvc._1.Helpers;
...
public static class HtmlHelpers
{
        ...
        bool requirePageTemplate = true)
    {
        ...
        var templateFilter = helper.ViewContext.HttpContext.RequestServices.GetInstance<FilterTemplate>();
        var contentLoader = helper.ViewContext.HttpContext.RequestServices.GetInstance<IContentLoader>();

        IEnumerable<PageData> filter(IEnumerable<PageData> pages)
            => pages.FilterForDisplay(templateFilter, requirePageTemplate, requireVisibleInMenu);
        ...
        var menuItems = contentLoader.GetChildren<PageData>(rootLink)
            .FilterForDisplay(templateFilter, requirePageTemplate, requireVisibleInMenu)
