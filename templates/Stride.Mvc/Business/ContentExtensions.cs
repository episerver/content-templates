...
public static class ContentExtensions
{
    ...
    /// </summary>
    public static IEnumerable<T> FilterForDisplay<T>(this IEnumerable<T> contents, FilterTemplate templateFilter, bool requirePageTemplate = false, bool requireVisibleInMenu = false)
        where T : IContent
    {
