...
namespace Stride.Mvc._1.Business.Initialization;
...
public class DisplayTemplateInitialization : IInitializableModule
{
    ...
    {
        Converters = { new ContentTypeBaseConverter() }
    };
    ...
    public void Initialize(InitializationEngine context)
    {
        ...
        var templates = JsonSerializer.Deserialize<List<DisplayTemplate>>(json, JsonOptions);
